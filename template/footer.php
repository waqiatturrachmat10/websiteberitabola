    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-left mb-10">
            ...
            <div>
                ...
                <p class="text-xs text-white/60 font-medium">Platform berita sepak bola modern dengan semangat Blaugrana. Berita valid dan cepat.</p>
            </div>
            ...
            <div>
                <h5 class="text-sm font-bold uppercase mb-4 text-barca-gold">Ikuti Kami</h5>
                <div class="flex gap-4 text-xl">
                    <a href="#" class="text-white/60 hover:text-barca-gold transition hover:scale-110"><i class="fab fa-twitter"></i></a>
                    <a href="#" class="text-white/60 hover:text-barca-gold transition hover:scale-110"><i class="fab fa-instagram"></i></a>
                    <a href="#" class="text-white/60 hover:text-barca-gold transition hover:scale-110"><i class="fab fa-youtube"></i></a>
                </div>
            </div>
        </div>

        <div class="border-t border-white/10 pt-6 text-center">
            <p class="text-xs text-white/50 font-bold uppercase tracking-widest">&copy; <?php echo date("Y"); ?> SkyGoal News. Visca el Barca!</p>
        </div>
    </div>
</footer>